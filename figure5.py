...
h0_vals = 15 * np.logspace(-14.2, -11.2, 50)
...
ax.set_ylabel(r"Scaling terms", fontsize=22)

ax.plot(h0_vals, T1_vals, lw=2, label=r"$|T_1|$")
ax.plot(h0_vals, T2_vals, lw=2, label=r"$|T_2|$")
ax.plot(h0_vals, T3_vals, lw=2, label=r"$|T_3|$")
ax.plot(h0_vals, Sig_vals, lw=2, label=r"$\Sigma$")

ax.plot(h0_vals, h0_vals, 'k--', lw=2, label=r"$h_0$")
ax.plot(h0_vals, 1e24 * h0_vals**3, 'k:', lw=2, label=r"$10^{24}\cdot h_0^{\,3}$")
